...
function append(data) {
    ...
    let apikey = "a13f4cc85868ed45fd11c7c18a191d70";
    let url =
    ...
    currentCity.innerHTML = `<div class="currentTemp">
        ...
        <div class="DayExpect">
            <p>Expect ${data.weather[0].main}. The high will be ${data.main.temp_max
        }°C.</p>
        </div>
    </div>
    <div class="todays-info">
        <div class="wind">
            <p>WIND</p>
            <p class="wind-speed">${data.wind.speed
        }km/h <i class="fa-solid fa-wind"></i></p>
        </div>
        <div class="humidity">
            <p>HUMIDITY</p>
            <p class="current-humidity"><i class="fa-solid fa-droplet"></i> ${data.main.humidity
        }%</p>
        </div>
    ...
    data.hourly.forEach(function (ele, index) {
        if (index == 0) {
            ...
            <div class="Todays-temp">
                <img src="http://openweathermap.org/img/wn/${ele.weather[0].icon
                }@2x.png" alt="">
                <div>
                    <p class="temp">${data.hourly[0].temp}°C</p>
                </div>
                <div class="todays-Weather">
                    <p class="today-weather">${data.hourly[0].weather[0].description
                }</p>
                    <p class="humidity"><i class="fa-solid fa-droplet"></i> ${ele.humidity
                }%</p>
                </div>
            </div>`;
        } else {
            ...
            FutureWeather.innerHTML += `<div>
                ...
                <div class="days-temp">
                    <img src="http://openweathermap.org/img/wn/${data.hourly[0].weather[0].icon
                }.png" alt="">
                    <div>
